$(function(){
 ...
 $('[data-toggle="tooltip"]').tooltip();
  ...
  $('#datecheck').change(function(){
    if($(this).is(":checked")) { 
        $('#byDate').addClass('d-block');
    } else {
        $('#byDate').removeClass('d-block');
    }
});

$('#mileagecheck').change(function(){
    if($(this).is(":checked")) { 
        $('#byMileage').addClass('d-block');
    } else {
        $('#byMileage').removeClass('d-block');
    }
});
$('#enginecheck').change(function(){
    if($(this).is(":checked")) { 
        $('#byengine').addClass('d-block');
    } else {
        $('#byengine').removeClass('d-block');
    }
});
$('#pushcheck').change(function(){
    if($(this).is(":checked")) { 
        $('#bypush').addClass('d-block');
    } else {
        $('#bypush').removeClass('d-block');
    }
});
